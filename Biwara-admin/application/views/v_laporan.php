	...
	<div class="main">
			...
			<div class="main-content">
               ...
               <tr>
                   ...
                   <td><?=$lpr->lokasi?></td>
                   <td><?=$lpr->deskripsi?></td>
                   <td><img src="<?=base_url('assets/img/'.str_replace(' ', '_',$lpr->gambar))?>" style="width:60px;"></td>
                   <td><?=$lpr->tanggal?></td>
                   <td colspan><a href="#update_laporan" data-toggle="modal" onclick="tm_detail(<?=$lpr->id_laporan?>)"  class="btn btn-info">Ubah</a>
